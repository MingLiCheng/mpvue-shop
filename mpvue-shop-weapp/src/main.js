...
export default {
  ...
  config: {
    ...
    "pages": ["pages/feedback/main", "pages/order/main", "pages/cart/main", "pages/mappage/main", "pages/collectlist/main", "pages/addressSelect/main", "pages/addaddress/main", "pages/address/main", "^pages/index/main", "pages/search/main", "pages/my/main", "pages/login/main", "pages/category/main", "pages/categorylist/main", "pages/topic/main", "pages/goods/main", "pages/logs/main", "pages/branddetail/main", "pages/brandlist/main", "pages/newgoods/main", "pages/practice/main", "pages/topicdetail/main", "pages/fight/main", "pages/bargain/main", "pages/myorder/main"],
    "window": {
      "backgroundTextStyle": "light",
      "navigationBarBackgroundColor": "#2588F0",
      "navigationBarTitleText": "洁美生鲜",
    ...
    "tabBar": {
      ...
      "list": [{
        ...
        },
        {
          ...
          "iconPath": "static/images/tabbar/ic_menu_sort_nor1.png",
          "selectedIconPath": "static/images/tabbar/ic_menu_sort_pressed.png",
          "text": "分类"
        },
        {
          "pagePath": "pages/cart/main",
          "iconPath": "static/images/tabbar/ic_menu_shoping_nor.png",
          "selectedIconPath": "static/images/tabbar/ic_menu_shoping_pressed.png",
          "text": "购物车"
        },
        {
