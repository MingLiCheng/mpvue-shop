 ...
 * @Date: 2020-04-13 23:08:56
 -->
<template>
  <section class="edit-bannerinfo-wrap">
...
export default {
  ...
  methods: {
    ...
    beforeBannerUrlUpload(file) {
      ...
      UploadFile.uploadFile(
        ...
        res => {
          console.log("res", res);
          if (res.ret_code == "200") {
            _this.form.image_url = res.img_path;
          }
    ...
    async editGoodsType(params) {
      const res = await this.$axios.post("/goodsManagement/editBannerInfoById", params);
      if (res.code !== -1) {
