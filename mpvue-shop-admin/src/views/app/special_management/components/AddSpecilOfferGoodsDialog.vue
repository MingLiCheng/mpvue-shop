<template>
  <section class="add-speciloffer-wrap">
      ...
      <el-form ref="form" :model="form" label-width="120px">
        <div class="left">
          ...
          <el-form-item label="优惠价格：">
            <el-input v-model="form.special_offer_price"></el-input>
          </el-form-item>
          <el-form-item label="商品数量：">
            <el-input v-model="form.special_goods_num"></el-input>
          </el-form-item>
        </div>
  ...
  methods: {
    submitForm() {
      ...
      if (this.dialogObj.type === "edit") {
        ...
        this.addSpecialOfferGoods(params)
      }
    ...
    async addSpecialOfferGoods(params) {
      params.end_time = new Date(params.end_time).getTime()
      const res = await this.$axios.post("/specialOffer/addSpecialOfferGoods", params);
      if (res.data.code !== -1) {
